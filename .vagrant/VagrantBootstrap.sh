...
debconf-set-selections <<< 'mysql-server-5.7 mysql-server/root_password password menuwave'
debconf-set-selections <<< 'mysql-server-5.7 mysql-server/root_password_again password menuwave'
echo "Installing mysql-server 5.7 with menuwave as root password"
